<div class="flex flex-col">
    ...
    <div class="w-full py-2">
        ...
        <input wire:model.lazy="couriers.credentials" type="text" name="courier_credentials" id="courier_credentials"
    ...
    <div class="w-full py-2">
        ...
        <input wire:model.lazy="couriers.return_address" type="text" name="courier_return_address" id="courier_return_address"
            class="px-2 py-1.5 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-sm">
    ...
    <div class="w-full py-2">
        ...
        <input wire:model.lazy="couriers.account_id" type="text" name="courier_account_id" id="courier_account_id"
            class="px-2 py-1.5 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-sm">
    ...
    <div class="w-full py-2">
        ...
        <input wire:model.lazy="couriers.return_email" type="text" name="courier_return_email" id="courier_return_email"
            class="px-2 py-1.5 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-sm">
    ...
    <div class="w-full py-2">
        ...
        <input wire:model.lazy="couriers.api_doc_url" type="text" name="courier_api_doc_url" id="courier_api_doc_url"
            class="px-2 py-1.5 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-sm">
    ...
    <div class="w-full py-2">
        ...
        <input wire:model.lazy="couriers.logo" type="file" name="courier_logo" id="courier_logo"
