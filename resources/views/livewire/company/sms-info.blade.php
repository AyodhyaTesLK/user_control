<div class="flex flex-col">
    ...
    <div class="w-full py-2">
        <label for="api_base_url" class="block text-sm font-medium text-gray-700">API base URL
    ...
    <div class="w-full py-2">
        ...
        <input type="text" name="sms_configuration_username" id="sms_configuration_username"
            class="px-2 py-1.5 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-sm">
    ...
    <div class="w-full py-2">
        ...
        <input type="text" name="sms_configuration_password" id="sms_configuration_password"
            class="px-2 py-1.5 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-sm">
    ...
    <div class="w-full py-2">
        ...
        <input type="text" name="sms_configuration_key" id="sms_configuration_key"
            class="px-2 py-1.5 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-sm">
    ...
    <div class="w-full py-2">
        ...
        <input type="text" name="sms_configuration_mask" id="sms_configuration_mask"
            class="px-2 py-1.5 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-sm">
    ...
    {{-- sms_api_document --}}
    <div class="w-full py-2">
        <label for="sms_api_document" class="block text-sm font-medium text-gray-700">API Document URL
            <span class="font-thin px-1">(optional, if available)</span>
        </label>

        <input type="text" name="sms_api_document" id="sms_api_document"
            class="px-2 py-1.5 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-sm">
        {{-- @error('sms_api_document') <span
                class="text-xs text-red-500 mt-1">{{ $message }}</span>
        @enderror --}}
    </div>
</div>
